// Tabler (tabler.io/icons) is the one icon set. Nuxt UI draws a few icons of its own
// (calendar arrows, close buttons, spinners...), so its defaults point at Tabler too.
