    ...
    <div>
        ...
        <div class="dash-grid mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div v-for="stat in stats" :key="stat.title" class="relative">
                <LibrarianCatalogStatTile :label="stat.title" :value="stat.value" :icon="stat.icon"
                    :tone="stat.tone" :class="{ 'opacity-40 transition-opacity': summaryPending }" />
...
.dash-grid>*:nth-child(7) {
    animation-delay: 260ms;
}

.dash-grid>*:nth-child(8) {
